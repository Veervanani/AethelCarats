...
exports.sendOrderDispatchEmail = exports.sendOrderConfirmationEmail = void 0;
...
const sendOrderDispatchEmail = async (order, courierCompany, trackingNumber) => {
    try {
        const transporter = createTransporter();
        const fromAddress = process.env.SMTP_FROM || `"Aura Diamond Atelier" <${process.env.SMTP_USER || 'concierge@auroradiamonds.com'}>`;
        const recipientEmail = order.customerEmail;
...
exports.sendOrderDispatchEmail = sendOrderDispatchEmail;
