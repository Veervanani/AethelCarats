...
exports.ensure22PagesContentSeeded = exports.DEFAULT_HOMEPAGE_SECTIONS = exports.INITIAL_22_PAGES_DATA = void 0;
const prisma_1 = __importDefault(require("../prisma"));
exports.INITIAL_22_PAGES_DATA = {
    'contact-us': {
...
exports.DEFAULT_HOMEPAGE_SECTIONS = [
    {
        blockType: 'HERO',
        position: 1,
        isVisible: true,
...
const ensure22PagesContentSeeded = async () => {
    try {
        // Seed home page if missing
        let homePage = await prisma_1.default.page.findUnique({
            where: { slug: 'home' },
            include: { sections: true },
        });
        if (!homePage) {
            homePage = await prisma_1.default.page.create({
                data: {
        ...
        if (homePage.sections.length === 0) {
            for (const s of exports.DEFAULT_HOMEPAGE_SECTIONS) {
        ...
        for (const [slug, data] of Object.entries(exports.INITIAL_22_PAGES_DATA)) {
...
exports.ensure22PagesContentSeeded = ensure22PagesContentSeeded;
