...
exports.capturePayPalOrder = exports.createPayPalOrder = exports.getPublicPayPalClientId = void 0;
...
const getPublicPayPalClientId = async (req, res) => {
    try {
...
exports.getPublicPayPalClientId = getPublicPayPalClientId;
...
const capturePayPalOrder = async (req, res) => {
    try {
        ...
        const response = await axios_1.default.post(`${baseUrl}/v2/checkout/orders/${paypalOrderId}/capture`, {}, {
            headers: {
                Authorization: `Bearer ${accessToken}`,
                'Content-Type': 'application/json',
            },
