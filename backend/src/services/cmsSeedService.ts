...
export const INITIAL_22_PAGES_DATA: Record<string, any> = {
  'contact-us': {
    heading: 'Contact Floksy Jewel Concierge',
    ...
    customerCareHeading: 'Floksy Atelier Customer Care',
  ...
  'returns-refunds': {
    ...
    introduction: 'At Floksy Jewel, your complete satisfaction is paramount. If for any reason you are not completely enchanted with your purchase, you may return it within 30 days of receipt.',
    ...
    returnProcess: 'Contact concierge@floksyjewel.com to receive a fully insured prepaid FedEx shipping label and Return Authorization (RA) number.',
    ...
    shippingResponsibility: 'Floksy Jewel provides complimentary insured return shipping labels for all domestic returns.',
  ...
  'shipping-delivery': {
    ...
    subheading: 'Every Floksy Jewel creation is dispatched via fully insured priority express air transportation.',
  ...
  'sustainability': {
    ...
    introduction: 'Floksy Jewel strictly enforces a zero-tolerance policy against conflict diamonds. Every natural diamond is 100% Kimberley Process certified.',
  ...
  'price-match': {
    ...
    subheading: 'If you find an identical GIA or IGI certified diamond at a lower price, Floksy Jewel will match or beat the price.',
    ...
    howItWorks: 'Submit the competitor diamond URL or certificate number to concierge@floksyjewel.com.',
  ...
  'lifetime-warranty': {
    heading: 'Floksy Jewel Lifetime Warranty',
    ...
    eligibility: 'Applies to all authentic Floksy Jewel rings, necklaces, bracelets, earrings, and custom CAD creations.',
  ...
  'insurance': {
    ...
    claims: 'Fast claims processing with direct replacement through Floksy Jewel Atelier.',
  ...
  'about-us': {
    heading: 'Quality & Value — The Floksy Jewel Legacy',
    subheading: 'Handcrafted luxury, uncompromised diamond excellence, and direct atelier pricing.',
    introduction: 'Founded on Fifth Avenue, Floksy Jewel bridges master European goldsmithing traditions with modern precision diamond cutting.',
    brandStory: 'Floksy Jewel was born out of a desire to eliminate bloated traditional luxury markups. By sourcing rough diamonds directly and hand-forging settings in-house, we deliver high jewellery at unprecedented value.',
    ourValues: 'Integrity, unyielding quality, complete diamond certification transparency, and personalized client relationships.',
    quality: 'Only the top 1% of gem-grade diamonds are selected for Floksy Jewel settings.',
    ...
    whyFloksyJewel: 'Direct diamond sourcing, bespoke CAD customization, conflict-free guarantee, and lifetime warranty.',
  },
  ...
  'blog': {
    heading: 'The Floksy Jewel Journal',
  ...
  'collections': {
    ...
    seoContent: 'Browse Floksy Jewel fine jewellery collections.',
  },

  'account': {
    title: 'Customer Account Portal',
    heading: 'Welcome to Your Floksy Jewel Atelier Account',
    ...
    supportInformation: 'Concierge Direct: +1 (800) 555-FLOKSY | concierge@floksyjewel.com',
  },
  ...
  'privacy-policy': {
    ...
    content: `
      ...
      <p>Floksy Jewel collects personal information necessary to fulfill orders, process payments, and provide personalized client service. This includes contact details, billing/shipping addresses, and payment information.</p>
      ...
      <h2>5. Your Rights</h2>
      <p>You have the right to request access to, update, or permanently delete your personal account data by contacting concierge@floksyjewel.com.</p>
    `,
  },
  ...
  'terms-of-service': {
    ...
    content: `
      ...
      <p>By accessing Floksy Jewel ("the Website") or placing an order, you agree to be bound by these Terms of Service and all applicable luxury retail laws.</p>
      ...
      <p>All 3D CAD renders, product designs, website photography, logos, and copywriting are the exclusive property of Floksy Jewel Atelier.</p>
  ...
  'jewellery-care': {
    ...
    content: `
      ...
      <p>Store individual pieces in your Floksy Jewel velvet pouch or soft-lined box to prevent stones from scratching each other.</p>
  ...
  'sitemap': {
    ...
    subheading: 'Navigate all pages, collections, loose diamond categories, and client resources across Floksy Jewel.',
  },
