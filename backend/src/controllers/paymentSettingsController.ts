...
export const getPaymentSettings = async (req: AuthRequest, res: Response) => {
  try {
    ...
    const settingsMap: Record<string, string> = {
      ...
      company_email: 'contact@gmail.com',
      ...
      receipt_notes: 'Official payment receipt generated by Floksy Jewel Atelier.',
      statement_footer_text: 'For inquiries regarding this statement, please contact contact@gmail.com.',
      paypal_client_id: '',
      paypal_client_secret: '',
      paypal_mode: 'sandbox',
    };
