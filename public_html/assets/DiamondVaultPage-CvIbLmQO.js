import{u as He,j as t,aT as Me,aN as Ue,r as l,X as h,ad as ge}from"./react-vendor-CKfE40gi.js";import{g as n}from"./ui-vendor-5voluciG.js";import{S as Ve,a as Z,R as I}from"./admin-pages-CjL1b0Kp.js";import{g as _e}from"./diamondImageHelper-BFWwNb-k.js";import{L as x}from"./LuxuryDropdown-BH03S18a.js";import{D as Ye,A as Xe,a as he}from"./diamondShapes-Cr3dfuxZ.js";import"./swiper-vendor-X0C8N8nm.js";import"./admin-tools-vendor-CKN5doRT.js";const ee=n.div`
...
`,rt=({diamond:o})=>{const z=He(),T=async M=>{M.stopPropagation();try{const P=await Z.getWhatsAppInquiryMessage(o.diamondId);window.open(P.whatsappUrl,"_blank")}catch{window.open(`https://wa.me/447900123456?text=Interested in diamond ${o.diamondId}`,"_blank")}},N=!!(o.fancyColor||o.color==="FANCY"),O=o.fancyColor?`${o.fancyIntensity||"FANCY"} ${o.fancyColor}`:null;return t.jsxs(ee,{"data-diamond-id":o.diamondId,onClick:()=>z(`/diamonds/${o.diamondId}`),children:[t.jsxs(qe,{children:[t.jsx(Ve,{src:_e(o),alt:`${o.carat}ct ${o.shape} Diamond`,loading:"lazy",width:"400",height:"400"}),t.jsx(Ke,{$isLab:o.diamondType==="LAB_GROWN",children:o.growthType?o.growthType:o.diamondType==="LAB_GROWN"?"Lab-Grown":"Natural"}),o.videoUrl&&t.jsx(Qe,{title:"360 Video Available",children:t.jsx(Me,{size:14,fill:"white"})})]}),t.jsxs(Je,{children:[t.jsxs(Ze,{children:[o.carat.toFixed(2),"ct ",o.shape]}),t.jsx(ue,{children:N&&O?t.jsx("span",{style:{color:"#c9a45c",fontWeight:600},children:O}):`${o.color} | ${o.clarity} | ${o.cut||"EXCELLENT"}`}),N&&t.jsxs(ue,{style:{fontSize:"0.78rem"},children:[o.clarity," | ",o.cut||"EXCELLENT"]}),o.lab&&t.jsxs(et,{children:[o.lab," CERTIFIED"]}),t.jsxs(tt,{children:["$",o.price.toLocaleString(),o.pricePerCarat&&t.jsxs("span",{style:{fontSize:"0.75rem",color:"#777",fontWeight:400,marginLeft:6},children:["($",Math.round(o.pricePerCarat).toLocaleString(),"/ct)"]})]}),t.jsx(ot,{onClick:T,children:"INQUIRE NOW"})]})]})},Q=["IGI","GIA","GCAL","HRD"],me=[{label:"PRICE: LOW → HIGH",value:"price-asc"},{label:"PRICE: HIGH → LOW",value:"price-desc"},{label:"CARAT: HIGH → LOW",value:"carat-desc"},{label:"CARAT: LOW → HIGH",value:"carat-asc"}],at=n.div`
  max-width: 1400px;
  margin: 0 auto;
