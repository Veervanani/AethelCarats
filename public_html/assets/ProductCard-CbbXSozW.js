import{r as w,j as i,H as C,h as S,f as B}from"./react-vendor-BQZO0c5l.js";import{g as t}from"./ui-vendor-Bs2yixgz.js";import{b as P,d as W,S as u}from"./admin-pages-wJt5vK3f.js";const l=t(B)`
  display: flex;
...
`,K=({product:e})=>{const{toggleWishlist:n,isInWishlist:j}=P(),{openQuickView:k}=W(),[p,c]=w.useState(!1),[m,z]=w.useState(0),f=j(e.id),s=[];Array.isArray(e.images)&&e.images.length>0&&[...e.images].sort((o,r)=>((o==null?void 0:o.position)??0)-((r==null?void 0:r.position)??0)).forEach(o=>{const r=typeof o=="string"?o:o==null?void 0:o.url;r&&typeof r=="string"&&r.trim()!==""&&s.push(r.trim())}),e.primaryImage&&typeof e.primaryImage=="string"&&s.push(e.primaryImage.trim()),e.mainImage&&typeof e.mainImage=="string"&&s.push(e.mainImage.trim()),e.secondaryImage&&typeof e.secondaryImage=="string"&&s.push(e.secondaryImage.trim());const I=s.filter(a=>a&&!a.includes("gem_rings_cat.png")&&!a.includes("gem_rings_cat_2.png")),b=Array.from(new Set(I)),d=Array.from(new Set(s.filter(Boolean))),g=b[0]||d[0]||"",h=b[1]||(d[1]&&d[1]!==g?d[1]:null)||null,x=!!(h&&h!==g),$=a=>{a.preventDefault(),a.stopPropagation(),n(e)},E=a=>{x&&z(o=>o===0?1:0)},A=`/product/${e.slug||e.id}`;return i.jsxs(l,{to:A,"data-testid":"product-card",onMouseEnter:()=>c(!0),onMouseLeave:()=>c(!1),onTouchStart:()=>c(!0),onTouchEnd:()=>c(!1),children:[i.jsxs(D,{onClick:E,children:[i.jsx(F,{$isHovered:p&&x,$activeIdx:m,children:i.jsx(u,{src:g,alt:e.name,loading:"lazy",width:"400",height:"400"})}),x&&i.jsx(H,{$isHovered:p,$activeIdx:m,children:i.jsx(u,{src:h,alt:`${e.name} alternate view`,loading:"lazy",width:"400",height:"400"})}),i.jsxs(L,{children:[!!(e.onSale||e.salePrice)&&i.jsx(y,{style:{backgroundColor:"#d93838",color:"#ffffff",borderColor:"#d93838",fontWeight:700},children:"🏷️ ON SALE"}),e.metal&&i.jsx(y,{children:e.metal})]}),i.jsx(T,{$isLiked:f,onClick:$,title:"Add to Wishlist","aria-label":"Add to Wishlist",children:i.jsx(C,{size:16,fill:f?"#d93838":"none"})}),i.jsxs(N,{$isHovered:p,onClick:a=>k(e,a),title:"Quick View Product Details","aria-label":"Quick View Product Details",children:[i.jsx(S,{size:14})," QUICK VIEW"]}),x&&i.jsxs(Q,{children:[i.jsx(v,{$active:m===0}),i.jsx(v,{$active:m===1})]})]}),i.jsxs(V,{children:[i.jsx(U,{children:e.name}),(e.carat||e.shape)&&i.jsxs(_,{children:[e.carat?`${e.carat}ct `:"",e.shape||"Brilliant",e.color?` • ${e.color}`:"",e.clarity?` / ${e.clarity}`:""]}),i.jsxs(M,{children:[i.jsxs("span",{className:"price",style:{color:e.onSale&&e.salePrice?"#E53E3E":"#C9A96E",fontWeight:700},children:["$",(e.salePrice&&e.onSale?e.salePrice:e.price||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})]}),!!(e.onSale&&e.comparePrice&&Number(e.comparePrice)>Number(e.salePrice||e.price||0))&&i.jsxs("span",{className:"compare",children:["$",Number(e.comparePrice).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})]})]})]})]})};export{K as P};
