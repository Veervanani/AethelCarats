import{r as c,j as e,X as qe,k as Te,l as Ie,aT as Ot,aU as vt,aa as Mt,R as Ne,t as We,ag as Wt,ao as _t,u as Gt,f as X,g as _e,C as xt,H as Ut,M as gt,P as ut,aV as Ht,ax as Ge,v as Ue,aR as He,c as Yt,a as Jt}from"./react-vendor-BsBv4awM.js";import{g as n}from"./ui-vendor-C0FaE403.js";import{S as mt,a as ee,R as Ke,u as Vt,b as Kt,c as qt}from"./admin-pages-DDF5_dHZ.js";import{P as jt}from"./ProductCard-wazbkAJZ.js";import"./swiper-vendor-X0C8N8nm.js";import"./admin-tools-vendor-CKN5doRT.js";const Xt=n.div`
  position: fixed;
  inset: 0;
...
`,$i=({currentProductId:r,content:x})=>{const[i,b]=c.useState([]),C=Ne.useRef(null);if(x&&(x.recentlyViewedEnabled===!1||x.showRecentlyViewed===!1))return null;const j=(x==null?void 0:x.recentlyViewedTitle)||"Recently Viewed";c.useEffect(()=>{let l=[];try{const g=localStorage.getItem("app_recently_viewed");g&&(l=JSON.parse(g))}catch{}const S=new Set,T=g=>{const F=[];g.id&&F.push(`id:${g.id}`),g.slug&&F.push(`slug:${g.slug}`);const D=(g.title||g.name||"").trim().toLowerCase();return D&&F.push(`name:${D}`),F};r&&S.add(`id:${r}`);const z=[];for(const g of l){if(!g)continue;const F=T(g);F.some(N=>S.has(N))||(z.push(g),F.forEach(N=>S.add(N)))}ee.getProducts({limit:16,status:"ACTIVE"}).then(g=>{const F=Array.isArray(g)?g:(g==null?void 0:g.products)||[],D=[...z];for(const N of F){if(!N)continue;const V=T(N);V.some(d=>S.has(d))||(D.push(N),V.forEach(d=>S.add(d)))}b(D.length>0?D:ge)}).catch(()=>{b(z.length>0?z:ge)})},[r]);const w=i.length>0?i:ge,h=new Set,v=w.filter(l=>{if(!l)return!1;const S=l.id?`id:${l.id}`:null,T=l.slug?`slug:${l.slug}`:null,z=(l.title||l.name||"").trim().toLowerCase(),g=z?`name:${z}`:null;return S&&h.has(S)||T&&h.has(T)||g&&h.has(g)?!1:(S&&h.add(S),T&&h.add(T),g&&h.add(g),!0)}),m=l=>{if(C.current){const S=l==="left"?-340:340;C.current.scrollBy({left:S,behavior:"smooth"})}};return e.jsx(Ke,{yOffset:35,children:e.jsxs(Ni,{children:[e.jsxs(Bi,{children:[e.jsx("h2",{children:j}),e.jsx("a",{href:"/rings",className:"see-all",children:"See All ›"})]}),e.jsxs(St,{children:[v.length>3&&e.jsx(ze,{$direction:"left",onClick:()=>m("left"),children:e.jsx(Te,{size:22})}),e.jsx(Ct,{ref:C,children:v.map((l,S)=>e.jsx(Ke,{staggerIndex:S,yOffset:25,style:{flexShrink:0},children:e.jsx(jt,{product:l})},l.id||`rec_${S}`))}),v.length>3&&e.jsx(ze,{$direction:"right",onClick:()=>m("right"),children:e.jsx(Ie,{size:22})})]})]})})},Je=n.div`
  background-color: #0B0B0B;
  min-height: 100vh;
  width: 100%;
`,Ae=n.div`
...
`,yt=({src:r,alt:x,style:i,onLoad:b})=>{const[C,j]=c.useState(r);return c.useEffect(()=>{j(r)},[r]),e.jsx("img",{src:C||"/assets/gem_rings_cat.png",alt:x,style:i,onLoad:b,onError:()=>{C!=="/assets/gem_rings_cat.png"&&j("/assets/gem_rings_cat.png")}})},wt=[{id:"exp",title:"YOUR AETHELCARATS EXPERIENCE",content:"Every creation is handcrafted in our Surat atelier using certified conflict-free materials and 100% recycled precious metals. Includes complimentary sizing, insured shipping, and lifetime cleaning.",enabled:!0,defaultOpen:!0},{id:"specs",title:"PRODUCT & DIAMOND SPECIFICATIONS",content:"Hand-selected center stone with optical precision cut. Crafted in solid 14k/18k gold with stamped hallmark verification.",enabled:!0,defaultOpen:!1},{id:"craft",title:"CRAFTSMANSHIP & SUSTAINABILITY",content:"Our Surat workshop directly sources lab-grown and natural diamonds, eliminating traditional markups and maintaining ethical standards.",enabled:!0,defaultOpen:!1},{id:"shipping",title:"SHIPPING & DELIVERY",content:"Free insured worldwide shipping with signature confirmation. Standard production time is 7 to 12 business days.",enabled:!0,defaultOpen:!1}],vr=({saleEndsAt:r})=>{const[x,i]=c.useState(null);return c.useEffect(()=>{const b=()=>{const j=new Date(r).getTime(),w=new Date().getTime(),h=j-w;if(isNaN(j)||h<=0){i(null);return}const v=Math.floor(h/(1e3*60*60*24)),m=Math.floor(h%(1e3*60*60*24)/(1e3*60*60)),l=Math.floor(h%(1e3*60*60)/(1e3*60)),S=Math.floor(h%(1e3*60)/1e3);i({days:v,hours:m,mins:l,secs:S})};b();const C=setInterval(b,1e3);return()=>clearInterval(C)},[r]),x?e.jsxs(wr,{children:[e.jsx("div",{className:"timer-header",children:e.jsx("span",{children:"⏳ Limited Time Offer — Sale Ends In:"})}),e.jsxs("div",{className:"timer-units",children:[e.jsxs("div",{className:"unit-card",children:[e.jsx("div",{className:"unit-num",children:String(x.days).padStart(2,"0")}),e.jsx("div",{className:"unit-label",children:"Days"})]}),e.jsxs("div",{className:"unit-card",children:[e.jsx("div",{className:"unit-num",children:String(x.hours).padStart(2,"0")}),e.jsx("div",{className:"unit-label",children:"Hours"})]}),e.jsxs("div",{className:"unit-card",children:[e.jsx("div",{className:"unit-num",children:String(x.mins).padStart(2,"0")}),e.jsx("div",{className:"unit-label",children:"Mins"})]}),e.jsxs("div",{className:"unit-card",children:[e.jsx("div",{className:"unit-num",children:String(x.secs).padStart(2,"0")}),e.jsx("div",{className:"unit-label",children:"Secs"})]})]})]}):null},jr=(r,x)=>{let i=(r||"").trim();const b=`
...
📩 Reach out if you need advice on picking a stone or want to start a custom build!`;if(i.length>500&&(i.includes("AethelCarats")||i.includes("Aura Diamond Atelier"))&&i.includes("Surat"))return i;const C=["Every piece we make","Every piece we make is done to order right here in ou","Every piece we make is done to order right here inour S","Every piece we make is done to order right here in","Handcrafted & Made to Order","ðŸ’Ž Handcrafted & Made to Order","🔹 Handcrafted & Made to Order","💎 Handcrafted & Made to Order"];let j=i;for(const w of C){const h=j.lastIndexOf(w);if(h>20){j=j.substring(0,h).trim();break}}return j||(j=x||"AethelCarats Fine Jewellery Atelier Fine Jewelry Piece"),j+b},Tr=()=>{var ct,dt;const{slug:r}=_t(),x=Gt(),[i,b]=c.useState(null),[C,j]=c.useState([]),[w,h]=c.useState(0),[v,m]=c.useState(!1),[l,S]=c.useState(null),[T,z]=c.useState("loading"),g=c.useRef(null),F=c.useRef(null),D=c.useRef(null),[N,V]=c.useState("14K Yellow Gold"),[le,d]=c.useState("14k"),[u,O]=c.useState("Select"),[B,te]=c.useState(!1),[Be,ie]=c.useState(!1),[Xe,Ze]=c.useState(!1),[ye,Qe]=c.useState(""),[W,p]=c.useState(1),[k,M]=c.useState(!1),[_,re]=c.useState(!1),[$e,et]=c.useState("exp"),[G,ce]=c.useState({}),[ne,q]=c.useState({}),[oe,kt]=c.useState(null),[de,At]=c.useState({show:!1,message:"",type:"success"}),[L,Et]=c.useState({enableConsultAtelierExpert:"true",consultTitle:"Consult an AethelCarats Atelier Expert",consultDescription:"Speak directly with our AethelCarats Fine Jewellery Atelier specialists regarding custom design, diamond selection, or sizing guidance.",consultPhone:"+91973785306",consultPhoneLabel:"Call Atelier",consultEmail:"concierge@aethelcarats.com",consultEmailLabel:"Email Concierge",consultCloseLabel:"Close"}),{cartItems:we,addToCart:tt,updateQuantity:zt}=Vt(),{isInWishlist:Tt,toggleWishlist:It}=Kt(),{showToast:Nt}=qt(),ue=(t,o="success")=>{Nt(t,o)};c.useEffect(()=>{const t=()=>{window.scrollY>550?M(!0):M(!1)};return window.addEventListener("scroll",t,{passive:!0}),()=>window.removeEventListener("scroll",t)},[]),c.useEffect(()=>{const t=o=>{D.current&&!D.current.contains(o.target)&&te(!1)};return document.addEventListener("mousedown",t),()=>document.removeEventListener("mousedown",t)},[]),c.useEffect(()=>{ee.getSiteSettings().then(t=>{t&&typeof t=="object"&&Object.keys(t).length>0&&Et(o=>({...o,...t}))}).catch(console.error),ee.getHolidayModeStatus().then(kt).catch(console.error)},[]),c.useEffect(()=>{let t=!0;if(r){b(null),z("loading");const o=setTimeout(()=>{t&&(console.warn("Product request timed out after 10 seconds."),b(null),z("error"))},1e4);return ee.getProductBySlug(r).then(s=>{if(!t)return;clearTimeout(o);const y=(s==null?void 0:s.product)||(s!=null&&s.id?s:null);if(y&&y.id){b(y),j((s==null?void 0:s.relatedProducts)||[]),h(0),z("success");try{const A=localStorage.getItem("app_recently_viewed"),H=A?JSON.parse(A):[],J=(y.title||y.name||"").trim().toLowerCase(),Ce=H.filter(R=>{if(!R||R.id&&y.id&&R.id===y.id||R.slug&&y.slug&&R.slug===y.slug)return!1;const I=(R.title||R.name||"").trim().toLowerCase();return!(J&&I&&J===I)}),E=[y,...Ce].slice(0,10);localStorage.setItem("app_recently_viewed",JSON.stringify(E))}catch{}if(y.metal){const A=y.metal.includes("Silver")?"14K White Gold":y.metal;V(A),d(A.includes("18K")?"18k":"14k")}else if(y.metalsConfig){let A=y.metalsConfig;if(typeof A=="string")try{A=JSON.parse(A)}catch{}if(Array.isArray(A)&&A.length>0){const H=A[0],J=typeof H=="string"?H:H.label||H.name;J&&(V(J),d(String(J).includes("18K")?"18k":"14k"))}}ee.get(`/product-page-content/${y.id}`).then(A=>{t&&A.data&&A.data.content&&S(A.data.content)}).catch(console.error);let f=[];try{y.accordionsConfig&&(f=typeof y.accordionsConfig=="string"?JSON.parse(y.accordionsConfig):y.accordionsConfig)}catch{}(!f||f.length===0)&&(f=wt);const $=f.find(A=>A.enabled!==!1&&A.defaultOpen);$&&et($.id||$.title)}else b(null),z("not_found")}).catch(s=>{var y;t&&(clearTimeout(o),console.error("Error fetching product by slug:",s),b(null),((y=s==null?void 0:s.response)==null?void 0:y.status)===404||(s==null?void 0:s.status)===404?z("not_found"):z("error"))}),()=>{t=!1,clearTimeout(o)}}else b(null),z("not_found")},[r]);const[ve,it]=c.useState(null),[rt,nt]=c.useState(null);c.useEffect(()=>{var t;if(i){const o=i.reviewCount??(((t=i.reviews)==null?void 0:t.length)||0),s=i.avgRating??5;it(o),nt(s);let y=!0;return ee.get(`/reviews?productId=${i.id}`).then(f=>{if(!y)return;const $=Array.isArray(f.data)?f.data:Array.isArray(f)?f:[];if($.length>0){it($.length);const A=$.reduce((H,J)=>H+(Number(J.rating)||5),0);nt(Math.round(A/$.length*10)/10)}}).catch(console.error),()=>{y=!1}}},[i==null?void 0:i.id]),c.useLayoutEffect(()=>{i&&window.scrollTo(0,0)},[i==null?void 0:i.id]);const me=c.useMemo(()=>!i||!we?-1:we.findIndex(t=>{var o;return(t.id===i.id||((o=t.product)==null?void 0:o.id)===i.id||t.productId===i.id)&&(!N||t.selectedMetal===N)}),[we,i==null?void 0:i.id,N]),pe=me>=0?we[me]:null;c.useEffect(()=>{pe&&pe.quantity&&p(pe.quantity)},[pe==null?void 0:pe.quantity,me]);const je=t=>{const o=Math.max(1,t),s=o-W;p(o),me>=0&&s!==0&&zt(me,s)},Bt=t=>{et(o=>o===t?null:t)},$t=()=>{if(!g.current)return;const t=g.current.scrollLeft,o=g.current.clientWidth;if(o>0){const s=Math.round(t/o);s!==w&&s>=0&&s<U.length&&h(s)}},Re=t=>{if(h(t),g.current){const o=g.current.clientWidth;g.current.scrollTo({left:t*o,behavior:"smooth"})}};if(T==="loading")return e.jsx(Ae,{style:{textAlign:"center",padding:80},children:e.jsx("div",{style:{fontFamily:"Cormorant Garamond, serif",fontSize:"1.6rem",color:"#c9a45c",letterSpacing:"0.08em"},children:"LOADING AETHELCARATS PRODUCT..."})});if(T==="not_found"||!i&&T!=="error")return e.jsx(Je,{children:e.jsxs(Ae,{style:{paddingBottom:60},children:[e.jsxs(Ve,{children:[e.jsx(X,{to:"/",children:"Home"})," / ",e.jsx(X,{to:"/collections",children:"Jewellery"})," / ",e.jsx("span",{className:"current",children:"Product Not Found"})]}),e.jsxs(bt,{children:[e.jsx("div",{className:"not-found-icon",children:e.jsx(_e,{size:28})}),e.jsx("h1",{children:"PRODUCT NOT FOUND"}),e.jsx("p",{children:"We're sorry, but this product is no longer available."}),e.jsx("div",{className:"cta-group",children:e.jsx(X,{to:"/collections",className:"btn-primary",children:"VIEW ALL JEWELLERY"})})]})]})});if(T==="error"||!i)return e.jsx(Je,{children:e.jsxs(Ae,{style:{paddingBottom:60},children:[e.jsxs(Ve,{children:[e.jsx(X,{to:"/",children:"Home"})," / ",e.jsx(X,{to:"/collections",children:"Jewellery"})," / ",e.jsx("span",{className:"current",children:"Error Loading Product"})]}),e.jsxs(bt,{children:[e.jsx("div",{className:"not-found-icon",style:{color:"#c5221f",background:"#fdf2f2",borderColor:"#f8d7da"},children:e.jsx(xt,{size:28})}),e.jsx("h1",{children:"UNABLE TO LOAD PRODUCT"}),e.jsx("p",{children:"We encountered a temporary network or server error while loading this piece. Please try again."}),e.jsxs("div",{className:"cta-group",children:[e.jsx("button",{className:"btn-primary",onClick:()=>window.location.reload(),children:"RETRY"}),e.jsx(X,{to:"/collections",className:"btn-secondary",children:"VIEW ALL JEWELLERY"})]})]})]})});const ot=Tt(i.id),Rt=i.images&&Array.isArray(i.images)&&i.images.length>0?i.images.map(t=>typeof t=="string"?t:t==null?void 0:t.url):[i.primaryImage||i.mainImage,i.secondaryImage],U=Array.from(new Set(Rt.filter(Boolean))),Ft=U[w]||U[0]||"",he=!!(((i.jewelleryType||"").toLowerCase()==="rings"||(i.jewelleryType||"").toLowerCase()==="engagement rings"||(i.jewelleryType||"").toLowerCase()==="wedding bands"||(((ct=i.category)==null?void 0:ct.name)||"").toLowerCase().includes("ring")||(i.name||"").toLowerCase().includes("ring")||i.enableRingSize===!0)&&!(i.jewelleryType||"").toLowerCase().includes("earring")&&!(i.jewelleryType||"").toLowerCase().includes("necklace")&&!(i.jewelleryType||"").toLowerCase().includes("bracelet")&&!(i.jewelleryType||"").toLowerCase().includes("pendant")),Z=!!(i.onSale===!0&&(i.comparePrice&&Number(i.comparePrice)>Number(i.price)||i.salePrice&&Number(i.salePrice)>0)),Fe=Z&&i.comparePrice&&Number(i.comparePrice)>Number(i.price)?Number(i.comparePrice):Z&&i.salePrice&&Number(i.price)>Number(i.salePrice)?Number(i.price):null;let se=i.metalsConfig;if(typeof se=="string")try{se=JSON.parse(se)}catch{se=[]}const Pe=!Array.isArray(se)||se.length===0?[{label:"14K Yellow Gold",code:"14k",priceAdjustment:0},{label:"14K White Gold",code:"14k",priceAdjustment:0},{label:"14K Rose Gold",code:"14k",priceAdjustment:0},{label:"18K Yellow Gold",code:"18k",priceAdjustment:250},{label:"18K White Gold",code:"18k",priceAdjustment:350},{label:"18K Rose Gold",code:"18k",priceAdjustment:350}]:se.map(t=>typeof t=="string"?{label:t,code:t.toLowerCase().includes("18k")?"18k":"14k",priceAdjustment:0}:{label:t.label||t.name||String(t),code:t.code||(String(t.label||"").toLowerCase().includes("18k")?"18k":"14k"),priceAdjustment:typeof t.priceAdjustment=="number"?t.priceAdjustment:0}),De=(i.variations||[]).find(t=>{const o=t.metal?t.metal.toLowerCase()===N.toLowerCase():!0,s=he&&u!=="Select"&&t.ringSize?String(t.ringSize)===String(u):!0;return o&&s});let Le=De==null?void 0:De.price;if(!Le){const t=Pe.find(s=>s.label.toLowerCase()===N.toLowerCase());Le=(Z&&i.salePrice&&Number(i.salePrice)>0?Number(i.salePrice):i.price||2500)+((t==null?void 0:t.priceAdjustment)||0)}const st=Object.values(G).reduce((t,o)=>t+(o.priceAdjustment||0),0),ae=Le+st;let Se=null;if(Z&&Fe&&Fe>ae){const t=Pe.find(o=>o.label.toLowerCase()===N.toLowerCase());Se=Fe+((t==null?void 0:t.priceAdjustment)||0)+st}const Pt=["Select","US 4","US 4.5","US 5","US 5.5","US 6","US 6.5","US 7","US 7.5","US 8","US 8.5","US 9","US 9.5","US 10","US 10.5","US 11","US 11.5","US 12"];let xe=[];try{i.customOptions?xe=typeof i.customOptions=="string"?JSON.parse(i.customOptions):i.customOptions:i.customOptionsJson&&(xe=typeof i.customOptionsJson=="string"?JSON.parse(i.customOptionsJson):i.customOptionsJson)}catch{}let K=[];try{i.detailSections&&Array.isArray(i.detailSections)&&i.detailSections.length>0?K=[...i.detailSections]:i.accordionsConfig&&(K=typeof i.accordionsConfig=="string"?JSON.parse(i.accordionsConfig):[...i.accordionsConfig])}catch{}(!K||K.length===0)&&(K=[...wt]);const Dt=i.fullDescription||i.description||i.shortDescription,fe=jr(Dt,i.title||i.name);if(fe&&typeof fe=="string"&&fe.trim()!==""){const t=K.findIndex(o=>o.id==="overview"||(o.title||"").toUpperCase().includes("DESCRIPTION")||(o.title||"").toUpperCase().includes("OVERVIEW"));t!==-1?K[t]={...K[t],title:"PRODUCT OVERVIEW & DESCRIPTION",content:fe.trim(),enabled:!0}:K.unshift({id:"overview",title:"PRODUCT OVERVIEW & DESCRIPTION",content:fe.trim(),enabled:!0,defaultOpen:!0})}const Lt=K.filter(t=>t.isActive!==!1&&t.enabled!==!1),Oe=he&&i.isRingSizeRequired!==!1,at=()=>{if(Oe&&(u==="Select"||!u)){ie(!0),ue("Please select a US Ring Size before adding to your bag.","warning");return}ie(!1);const t={};if(i.enableCustomOptions){for(const o of xe)if(o.required){const s=G[o.title||o.name||o.label];(!s||!s.value||!s.value.trim())&&(t[o.title||o.name||o.label]=`Please complete required option: ${o.title||o.name||o.label}`)}}if(Object.keys(t).length>0){q(t),ue(Object.values(t)[0],"warning");return}q({}),tt(i,W,N,he?u==="Select"?"US 7":u:void 0,ye,G,ae),ue("Product successfully added to your shopping bag!","success")},lt=()=>{if(Oe&&(u==="Select"||!u)){ie(!0),ue("Please select a US Ring Size before proceeding to checkout.","warning");return}ie(!1);const t={};if(i.enableCustomOptions){for(const o of xe)if(o.required){const s=G[o.title||o.name||o.label];(!s||!s.value||!s.value.trim())&&(t[o.title||o.name||o.label]=`Please complete required option: ${o.title||o.name||o.label}`)}}if(Object.keys(t).length>0){q(t),ue(Object.values(t)[0],"warning");return}q({}),tt(i,W,N,he?u==="Select"?"US 7":u:void 0,ye,G,ae),x("/checkout")};return e.jsxs(Je,{children:[e.jsxs(Ae,{children:[e.jsxs(Ve,{children:[e.jsx(X,{to:"/",children:"Home"})," / ",e.jsx(X,{to:"/collections",children:((dt=i.category)==null?void 0:dt.name)||i.jewelleryType||"Jewellery"})," / ",e.jsx("span",{className:"current",children:i.title||i.name})]}),e.jsxs(Ri,{children:[e.jsx(Fi,{children:e.jsx(Pi,{ref:F,children:e.jsx(Di,{className:"desktop-image-grid",children:U.map((t,o)=>e.jsxs(Li,{onClick:()=>{h(o),m(!0)},children:[e.jsx(yt,{src:t,alt:`${i.title||i.name} view ${o+1}`}),e.jsxs("div",{className:"zoom-hint",children:[e.jsx(vt,{size:12}),"Click to expand"]})]},`gallery_${t}_${o}`))})})}),e.jsxs(Oi,{children:[U.length>0&&e.jsxs(_i,{children:[w+1," / ",U.length]}),U.length>1&&w>0&&e.jsx(ft,{$dir:"left",onClick:()=>Re(w-1),"aria-label":"Previous Image",children:e.jsx(Te,{size:20})}),U.length>1&&w<U.length-1&&e.jsx(ft,{$dir:"right",onClick:()=>Re(w+1),"aria-label":"Next Image",children:e.jsx(Ie,{size:20})}),e.jsx(Mi,{ref:g,onScroll:$t,children:U.map((t,o)=>e.jsx(Wi,{onClick:()=>{h(o),m(!0)},children:e.jsx(yt,{src:t,alt:`${i.title||i.name} view ${o+1}`})},`mob_${o}`))}),e.jsx(Gi,{children:U.map((t,o)=>e.jsx("span",{className:w===o?"active":"",onClick:()=>Re(o)},o))})]}),e.jsx(ai,{images:U,activeIndex:w,productName:i.title||i.name,isOpen:v,onClose:()=>m(!1),onSelectIndex:t=>h(t)}),e.jsxs(Ui,{children:[e.jsxs(Hi,{children:[e.jsxs("div",{children:[e.jsx("h1",{children:i.title||i.name}),e.jsxs(Yi,{children:[e.jsxs("span",{className:"stars",children:["★".repeat(Math.round(rt??i.avgRating??5)),"☆".repeat(5-Math.round(rt??i.avgRating??5))]}),e.jsx("span",{children:ve!==null&&ve>0?`(${ve} ${ve===1?"review":"reviews"})`:i.reviewCount!==void 0&&i.reviewCount>0?`(${i.reviewCount} ${i.reviewCount===1?"review":"reviews"})`:"(No reviews yet)"})]})]}),e.jsx("button",{className:`wishlist-btn ${ot?"active":""}`,onClick:()=>It(i),title:"Save to Wishlist",children:e.jsx(Ut,{size:20,fill:ot?"#c00":"none"})})]}),e.jsxs(Ee,{children:[e.jsxs(Ji,{style:{marginTop:0,display:"flex",alignItems:"center",gap:14,flexWrap:"wrap"},children:[e.jsxs("span",{className:"current-price",style:{color:Z?"#E53E3E":"#C9A96E"},children:["$",ae.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})]}),Z&&Se!==null&&Se>ae&&e.jsxs("span",{className:"compare-price",children:["$",Se.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})]}),Z&&e.jsx("span",{style:{background:"#d93838",color:"#fff",fontSize:"0.75rem",fontWeight:700,padding:"4px 10px",borderRadius:4,letterSpacing:"0.04em"},children:"🏷️ ON SALE"})]}),!!(Z&&i.saleEndsAt)&&e.jsx(vr,{saleEndsAt:i.saleEndsAt})]}),i.enableMetalSelection!==!1&&e.jsxs(Ee,{children:[e.jsxs(Vi,{children:[e.jsx("span",{className:"label",children:"Metal Type:"}),e.jsx("span",{className:"value",children:N})]}),e.jsx(Ki,{children:Pe.map((t,o)=>e.jsx(qi,{type:"button",$isSelected:N.toLowerCase()===t.label.toLowerCase(),onClick:()=>{V(t.label),d(t.code)},title:t.label,children:t.label},o))})]}),he&&e.jsxs(Ee,{children:[e.jsxs(Xi,{children:[e.jsxs("span",{className:"label-title",children:["Ring Size ",Oe?e.jsx("span",{style:{color:"#d9534f"},children:"*"}):e.jsx("span",{style:{color:"#888",fontWeight:400,fontSize:"0.75rem"},children:"(Optional)"}),":"]}),e.jsxs(Zi,{ref:D,children:[e.jsxs(Qi,{onClick:()=>te(!B),children:[e.jsx("span",{className:u!=="Select"?"selected-val":"placeholder-val",children:u}),e.jsx("span",{className:"arrow-icon",children:e.jsx("svg",{width:"9",height:"6",viewBox:"0 0 9 6",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:e.jsx("path",{d:"M4.5 6L0 0H9L4.5 6Z",fill:"#0c1938"})})})]}),B&&e.jsx(er,{children:(i.availableRingSizes||Pt).map(t=>e.jsx("div",{className:`option-item ${u===t?"selected":""}`,onClick:()=>{O(t),te(!1),ie(!1)},children:t},t))})]}),e.jsx(X,{to:"/education/rings/find-your-ring-size",className:"guide-link",children:"Ring Size Guide"})]}),Be&&e.jsxs("div",{style:{color:"#d9534f",fontSize:"0.8rem",fontWeight:600,marginTop:8,display:"flex",alignItems:"center",gap:6},children:[e.jsx("span",{children:"⚠️"})," Please select a US Ring Size before adding this ring to your shopping bag."]})]}),!!i.enableCustomOptions&&xe.length>0&&e.jsx(Ee,{children:e.jsx(tr,{children:xe.map((t,o)=>{var A,H,J,Ce;const s=t.title||t.name||t.label;if(!s)return null;const y=t.inputType||t.fieldType||"Text",f=!!ne[s],$=Number(t.priceAdjustment)||0;return e.jsxs("div",{children:[e.jsxs(ir,{children:[s,(A=G[s])!=null&&A.value?`: ${G[s].value}`:"",t.required&&e.jsx("span",{style:{color:"#c5221f"},children:"*"}),y!=="Checkbox"&&$>0&&e.jsxs("span",{style:{color:"#137333",fontWeight:600,marginLeft:6},children:["(+$",$,")"]})]}),y==="Text"&&e.jsx(rr,{type:"text",$hasError:f,maxLength:t.maxCharacterLength||t.maxLength||25,placeholder:t.placeholder||`Enter ${s}...`,value:((H=G[s])==null?void 0:H.value)||"",onChange:E=>{const R=E.target.value;ce(I=>({...I,[s]:{title:s,value:R,priceAdjustment:R.trim()?$:0}})),ne[s]&&q(I=>({...I,[s]:""}))}}),y==="Textarea"&&e.jsx(nr,{rows:2,$hasError:f,maxLength:t.maxCharacterLength||t.maxLength||100,placeholder:t.placeholder||`Enter ${s}...`,value:((J=G[s])==null?void 0:J.value)||"",onChange:E=>{const R=E.target.value;ce(I=>({...I,[s]:{title:s,value:R,priceAdjustment:R.trim()?$:0}})),ne[s]&&q(I=>({...I,[s]:""}))}}),y==="Dropdown"&&e.jsxs(or,{$hasError:f,value:((Ce=G[s])==null?void 0:Ce.value)||"",onChange:E=>{const I=(t.choices||t.values||[]).find(Y=>(Y.label||Y.value||Y)===E.target.value),P=typeof I=="object"?Number(I.priceAdjustment)||0:$;ce(Y=>({...Y,[s]:{title:s,value:E.target.value,priceAdjustment:E.target.value?P:0}})),ne[s]&&q(Y=>({...Y,[s]:""}))},children:[e.jsxs("option",{value:"",children:["-- Select ",s," --"]}),(t.choices||t.values||[]).map((E,R)=>{const I=typeof E=="string"?E:E.label||E.value,P=typeof E=="object"&&Number(E.priceAdjustment)||0;return e.jsxs("option",{value:I,children:[I," ",P>0?`(+$${P})`:""]},R)})]}),y==="Radio"&&e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8},children:(t.choices||t.values||[]).map((E,R)=>{var Y;const I=typeof E=="string"?E:E.label||E.value,P=typeof E=="object"?Number(E.priceAdjustment)||0:$;return e.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:"0.88rem",cursor:"pointer",color:"#0c1938"},children:[e.jsx("input",{type:"radio",name:`opt_${s}`,checked:((Y=G[s])==null?void 0:Y.value)===I,onChange:()=>{ce(Q=>({...Q,[s]:{title:s,value:I,priceAdjustment:P}})),ne[s]&&q(Q=>({...Q,[s]:""}))},style:{accentColor:"#0c1938",cursor:"pointer"}}),I," ",P>0&&e.jsxs("span",{style:{color:"#137333",fontWeight:600},children:["(+$",P,")"]})]},R)})}),y==="Checkbox"&&(()=>{var I;const E=t.checkboxOptions&&Array.isArray(t.checkboxOptions)&&t.checkboxOptions.length>0?t.checkboxOptions:t.choices&&Array.isArray(t.choices)&&t.choices.length>0?t.choices:[{id:"cb_default",label:t.checkboxLabel!==void 0&&t.checkboxLabel!==""?t.checkboxLabel:s,priceAdjustment:$}],R=((I=G[s])==null?void 0:I.value)||"";return e.jsx("div",{children:e.jsx(sr,{children:E.map((P,Y)=>{const Q=typeof P=="string"?P:P.label||P.value;if(!Q)return null;const Me=typeof P=="object"&&Number(P.priceAdjustment)||0,pt=R===Q;return e.jsxs(ar,{type:"button",$isSelected:pt,onClick:()=>{ce(pt?be=>({...be,[s]:{title:s,value:"",priceAdjustment:0}}):be=>({...be,[s]:{title:s,value:Q,priceAdjustment:Me}})),ne[s]&&q(be=>({...be,[s]:""}))},children:[e.jsx("span",{children:Q}),Me>0&&e.jsxs("span",{style:{color:"#137333",fontWeight:600,marginLeft:6},children:["(+$$",Me,")"]})]},P.id||Y)})})})})(),f&&e.jsx("div",{style:{fontSize:"0.78rem",color:"#c5221f",marginTop:4},children:ne[s]})]},t.id||o)})})}),e.jsxs(lr,{style:{marginTop:4},children:[oe!=null&&oe.active?e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:10,width:"100%"},children:[e.jsx("button",{disabled:!0,style:{width:"100%",padding:"16px 24px",background:"#e2e8f0",color:"#64748b",border:"1px solid #cbd5e1",borderRadius:4,fontWeight:700,fontSize:"0.85rem",letterSpacing:"0.08em",textTransform:"uppercase",cursor:"not-allowed"},children:"ORDERS TEMPORARILY UNAVAILABLE"}),e.jsx("div",{style:{fontSize:"0.82rem",color:"#c53030",background:"#fff5f5",border:"1px solid #feb2b2",padding:"10px 14px",borderRadius:4,textAlign:"center",lineHeight:1.5},children:oe.message||"Orders are temporarily unavailable while Holiday Mode is active. Please check back soon."})]}):e.jsxs(cr,{children:[(l==null?void 0:l.showQuantitySelector)!==!1&&e.jsx("div",{className:"qty-selector-col",children:e.jsxs(dr,{children:[e.jsx("button",{type:"button",onClick:()=>je(W-1),"aria-label":"Decrease quantity",children:e.jsx(gt,{size:14})}),e.jsx("span",{children:W}),e.jsx("button",{type:"button",onClick:()=>je(W+1),"aria-label":"Increase quantity",children:e.jsx(ut,{size:14})})]})}),e.jsx("div",{className:"add-bag-col",children:e.jsxs(pr,{onClick:at,children:["ADD TO BAG • $",(ae*W).toLocaleString()]})}),(l==null?void 0:l.showBuyNowButton)!==!1&&e.jsx("div",{className:"buy-now-col",children:e.jsxs(xr,{onClick:lt,children:[e.jsx(Ht,{size:16})," BUY IT NOW"]})})]}),L.enableConsultAtelierExpert!=="false"&&e.jsx(gr,{onClick:()=>re(!0),children:"CONSULT AN ATELIER EXPERT"})]}),(l==null?void 0:l.showBenefits)!==!1&&e.jsx(ur,{children:l!=null&&l.benefitsJson?(()=>{try{return(typeof l.benefitsJson=="string"?JSON.parse(l.benefitsJson):l.benefitsJson).filter(o=>o.isActive!==!1).map((o,s)=>e.jsxs("div",{className:"benefit-item",children:[o.icon==="Truck"&&e.jsx(Ge,{size:16}),o.icon==="ShieldCheck"&&e.jsx(Ue,{size:16}),o.icon==="Award"&&e.jsx(He,{size:16}),o.icon==="Sparkles"&&e.jsx(_e,{size:16}),(!o.icon||!["Truck","ShieldCheck","Award","Sparkles"].includes(o.icon))&&e.jsx(Yt,{size:16}),o.title]},o.id||s))}catch{return null}})():e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"benefit-item",children:[e.jsx(Ge,{size:16})," Free Insured Delivery"]}),e.jsxs("div",{className:"benefit-item",children:[e.jsx(Ue,{size:16})," Lifetime Service Warranty"]}),e.jsxs("div",{className:"benefit-item",children:[e.jsx(He,{size:16})," GIA / IGI Certification"]})]})}),e.jsx(mr,{style:{marginTop:24},children:Lt.map((t,o)=>{const s=t.id||t.title||`acc_${o}`,y=$e===s;return e.jsxs(Ne.Fragment,{children:[e.jsxs(hr,{onClick:()=>Bt(s),children:[e.jsx("span",{children:t.title}),e.jsx("span",{children:y?"−":"+"})]}),e.jsxs(fr,{$open:y,children:[t.description&&e.jsx("div",{style:{fontSize:"0.88rem",color:"#D8D2C5",marginBottom:t.items&&t.items.length>0?14:0,lineHeight:1.7},children:t.description}),t.items&&Array.isArray(t.items)&&t.items.length>0?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:14},children:t.type==="SPECIFICATIONS"||(t.title||"").toUpperCase().includes("SPECIFICATION")?e.jsxs("div",{style:{background:"#151515",border:"1px solid rgba(140, 116, 75, 0.25)",padding:18,borderRadius:6,boxShadow:"0 4px 16px rgba(0, 0, 0, 0.4)"},children:[e.jsx("div",{style:{fontSize:"0.78rem",fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase",color:"#C9A96E",marginBottom:12},children:"SPECIFICATION DETAILS"}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gap:"12px 18px",fontSize:"0.85rem"},children:t.items.map((f,$)=>e.jsxs("div",{children:[f.title&&e.jsxs("strong",{style:{color:"#F5F1E8",fontWeight:600},children:[f.title,": "]}),e.jsx("span",{style:{color:"#D8D2C5"},children:f.value||f.description||"-"})]},f.id||$))})]}):t.items.map((f,$)=>e.jsxs("div",{style:{background:"#151515",border:"1px solid rgba(140, 116, 75, 0.25)",padding:16,borderRadius:6,display:"flex",flexDirection:"column",gap:6,boxShadow:"0 4px 16px rgba(0, 0, 0, 0.35)"},children:[f.imageUrl&&e.jsx("img",{src:f.imageUrl,alt:f.title||"Atelier Media",style:{width:"100%",maxHeight:220,objectFit:"cover",borderRadius:4,marginBottom:6}}),(f.title||f.icon)&&e.jsxs("div",{style:{fontSize:"0.92rem",fontWeight:700,color:"#F5F1E8",display:"flex",alignItems:"center",gap:8},children:[f.icon==="Truck"&&e.jsx(Ge,{size:16,color:"#C9A96E"}),f.icon==="ShieldCheck"&&e.jsx(Ue,{size:16,color:"#C9A96E"}),f.icon==="Award"&&e.jsx(He,{size:16,color:"#C9A96E"}),f.icon==="Sparkles"&&e.jsx(_e,{size:16,color:"#C9A96E"}),f.title]}),f.value&&e.jsx("div",{style:{fontSize:"0.88rem",fontWeight:600,color:"#C9A96E"},children:f.value}),f.description&&e.jsx("div",{style:{fontSize:"0.85rem",color:"#D8D2C5",lineHeight:1.6},children:f.description})]},f.id||$))}):!t.description&&e.jsx("div",{style:{whiteSpace:"pre-line",fontSize:"0.88rem",color:"#D8D2C5",lineHeight:1.7},children:t.content||"Information for this section."})]})]},s)})})]})]})]}),e.jsx(Ii,{items:C,currentProductId:i.id,content:l}),e.jsx(mi,{content:l}),e.jsx(Ei,{productName:i.name||i.title,content:l,productId:i.id,reviews:i.reviews}),e.jsx($i,{currentProductId:i.id,content:l}),_&&L.enableConsultAtelierExpert!=="false"&&e.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",zIndex:9999,display:"flex",justifyContent:"center",alignItems:"center"},children:e.jsxs("div",{style:{background:"#151515",border:"1px solid rgba(140, 116, 75, 0.3)",padding:32,borderRadius:8,maxWidth:500,width:"90%",textAlign:"center",color:"#F5F1E8"},children:[e.jsx("h3",{style:{fontFamily:"Cormorant Garamond, serif",fontSize:"1.8rem",color:"#F5F1E8",marginBottom:12},children:L.consultTitle||"Consult an Atelier Expert"}),e.jsx("p",{style:{fontSize:"0.9rem",color:"#A8A8A8",marginBottom:20,whiteSpace:"pre-line"},children:L.consultDescription||"Speak directly with our AethelCarats specialists regarding custom design, diamond selection, or sizing guidance."}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:12,marginBottom:20},children:[L.consultPhone&&L.consultPhone.trim()!==""&&e.jsxs("a",{href:`tel:${L.consultPhone.replace(/[^\d+]/g,"")}`,style:{padding:"12px",background:"#111111",border:"1px solid rgba(140, 116, 75, 0.25)",borderRadius:4,textDecoration:"none",color:"#F5F1E8",fontWeight:600},children:["☎ ",L.consultPhoneLabel||"Call Atelier",": ",L.consultPhone]}),L.consultEmail&&L.consultEmail.trim()!==""&&e.jsxs("a",{href:`mailto:${L.consultEmail.trim()}`,style:{padding:"12px",background:"#111111",border:"1px solid rgba(140, 116, 75, 0.25)",borderRadius:4,textDecoration:"none",color:"#F5F1E8",fontWeight:600},children:["✉ ",L.consultEmailLabel||"Email Concierge",": ",L.consultEmail]})]}),e.jsx("button",{onClick:()=>re(!1),style:{padding:"10px 24px",background:"#C9A96E",color:"#0B0B0B",border:"none",borderRadius:4,cursor:"pointer",fontWeight:700},children:L.consultCloseLabel||"Close"})]})}),e.jsxs(yr,{$show:de.show,$type:de.type,children:[e.jsx("div",{className:"toast-icon",children:de.type==="success"?e.jsx(Jt,{size:22}):e.jsx(xt,{size:22})}),e.jsx("div",{className:"toast-content",children:de.message}),e.jsx("button",{className:"toast-close",onClick:()=>At(t=>({...t,show:!1})),children:e.jsx(qe,{size:16})}),de.show&&e.jsx("div",{className:"progress-bar"},de.message)]}),e.jsx(br,{$show:k&&!(oe!=null&&oe.active)&&(l==null?void 0:l.showStickyBar)!==!1,children:e.jsxs("div",{className:"sticky-inner",children:[e.jsxs("div",{className:"product-info",children:[e.jsx("img",{src:Ft,alt:(i==null?void 0:i.title)||(i==null?void 0:i.name)||"Jewellery"}),e.jsxs("div",{className:"title-price",children:[e.jsx("div",{className:"title",children:(i==null?void 0:i.title)||(i==null?void 0:i.name)}),e.jsxs("div",{className:"meta-price",children:["$",(ae*W).toLocaleString()]})]})]}),e.jsxs("div",{className:"sticky-actions",children:[e.jsxs("div",{className:"sticky-qty",children:[e.jsx("button",{type:"button",onClick:()=>je(W-1),children:e.jsx(gt,{size:12})}),e.jsx("span",{children:W}),e.jsx("button",{type:"button",onClick:()=>je(W+1),children:e.jsx(ut,{size:12})})]}),e.jsx("button",{className:"sticky-btn add-bag",onClick:at,children:"ADD TO BAG"}),e.jsx("button",{className:"sticky-btn buy-now",onClick:lt,children:"BUY IT NOW"})]})]})})]})};export{Tr as ProductDetailPage};
